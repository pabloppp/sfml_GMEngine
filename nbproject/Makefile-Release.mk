...
OBJECTFILES= \
	...
	${OBJECTDIR}/demo/asteroidController.o \
...
LDLIBSOPTIONS=-Llibs/SFML-2.1/lib -Llibs/Box2D/lib -Llibs/json-c/.libs -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio -lsfml-network -ljson-c -lBox2D
...
${OBJECTDIR}/demo/asteroidController.o: demo/asteroidController.cpp 
	${MKDIR} -p ${OBJECTDIR}/demo
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -Ilibs/json-c -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/demo/asteroidController.o demo/asteroidController.cpp
